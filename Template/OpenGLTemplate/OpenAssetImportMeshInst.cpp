...
COpenAssetImportMeshInst::MeshEntry::MeshEntry()
{
...
void COpenAssetImportMeshInst::MeshEntry::Init(const std::vector<Vertex>& Vertices,
...
COpenAssetImportMeshInst::COpenAssetImportMeshInst()
{
}
...
void COpenAssetImportMeshInst::Clear()
{
...
bool COpenAssetImportMeshInst::Load(const std::string& Filename)
{
...
bool COpenAssetImportMeshInst::InitFromScene(const aiScene* pScene, const std::string& Filename)
{
...
void COpenAssetImportMeshInst::InitMesh(unsigned int Index, const aiMesh* paiMesh)
{
...
bool COpenAssetImportMeshInst::InitMaterials(const aiScene* pScene, const std::string& Filename)
{
...
void COpenAssetImportMeshInst::Render()
{
	glBindVertexArray(m_vao);
	...
	for (unsigned int i = 0; i < m_Entries.size(); i++) {
		...
		glDrawElementsInstanced(GL_TRIANGLES, m_Entries[i].NumIndices, GL_UNSIGNED_INT, 0, 1000);
